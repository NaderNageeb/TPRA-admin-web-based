...
<?php
// get user details
if(isset($_GET['edit_id']) && isset($_GET['action']) == 'edit'){
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php 
                           if($rows['status']==0){
                            ?>
                          <a href="manage_user.php?disactive_id=<?php echo $rows['user_id']; ?>&action=disactive" title="Non-active" class="badge badge-success">Active</a>

                           <?php }else{ ?>

                            <a href="manage_user.php?active_id=<?php echo $rows['user_id']; ?>&action=active" title="Activate" class="badge badge-danger">Not Active</a>
                           <?php } ?>
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="manage_user.php?edit_id=<?php echo $rows['user_id']; ?>&action=edit"><span class="btn btn-primary">Edit</span></a>
